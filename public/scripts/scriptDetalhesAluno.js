document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    if (cpfAluno) cpfAluno.value = aluno.cpf || "";

    const rgAluno = document.getElementById("rgAluno");
    if (rgAluno) rgAluno.value = aluno.rg || "";
    ...
    const cpfResp1 = document.getElementById("cpfResponsavel1");
    if (cpfResp1) cpfResp1.value = aluno.cpfResponsavel || "";
    ...
    const cpfResp2 = document.getElementById("cpfResponsavel2");
    if (cpfResp2) cpfResp2.value = aluno.cpfResponsavel2 || "";
